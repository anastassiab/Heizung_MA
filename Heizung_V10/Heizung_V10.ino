...
//Synchronisierung
  if(OutputPWM1 >= 0){
   ...
   if (OutputPWM1 != new_OutputPWM1){
     Serial.println("Freigabe"); // display if it changed
   new_OutputPWM1 = OutputPWM1;
   }
 }
...
/*
// Online-Anpassung der Sollwert Temperatur1  
void Solltemp1() {                 
...
if (Serial.available() > 0) {
    ...
    if ((temp2 >= '0') && (temp2 <= '9')) {
      ...
      SetpointTemperatur2 = temp2_1.toDouble() * sign2;
            Serial.print("Solltemp2 = ");
            Serial.println(SetpointTemperatur2);
